...
// Region order for sorting (lower = first)
export const REGION_ORDER = { US: 0, Europe: 1, LATAM: 2, Asia: 3, ANZ: 4, Canada: 5, Global: 6 };
...
const SECTORS_RAW = [
  {
    ...
    companies: [
      { name: "HubSpot", ticker: "HUBS", drop: -51, status: "public", region: "US", note: "Worst-hit CRM. SMB focus = low switching costs. Customers can leave overnight.", analystDetail: {
      ...
      { name: "monday.com", ticker: "MNDY", drop: -50, status: "public", region: "Global", note: "From $342 to ~$87. Launching AI Credits to replace seats. 21% single-day crash after earnings.", analystDetail: {
      ...
      { name: "Salesforce", ticker: "CRM", drop: -42, status: "public", region: "US", note: "52-week low ~$196. Agentforce adoption disappointing. Existential: agents pull from Gmail/Slack directly.", analystDetail: {
      ...
      { name: "Pipedrive", ticker: "private", drop: null, status: "private", region: "Europe", note: "Acquired by Vista Equity. SMB European CRM. Same existential risk, shielded from public panic." },
      { name: "Freshworks", ticker: "FRSH", drop: -10, status: "public", region: "Asia", note: "Piper Sandler downgrade citing 'seat compression and vibe coding.' Indian-origin, NASDAQ-listed." },
      { name: "Zoho CRM", ticker: "private", drop: null, status: "private", region: "Asia", note: "100M+ users. CEO called AI 'the pin popping this inflated balloon.' Private = no stock panic." },
    ],
  ...
  },
  {
    ...
    regulatoryShield: "None",
    companies: [
      { name: "Asana", ticker: "ASAN", drop: -59, status: "public", region: "US", note: "-92% from ATH. The single most punished SaaS stock in the SaaSpocalypse.", analystDetail: {
      ...
      { name: "monday.com", ticker: "MNDY", drop: -50, status: "public", region: "Global", note: "Also in CRM — 'Work OS' spans both categories. Equally vulnerable in each." },
      { name: "Smartsheet", ticker: "SMAR", drop: -35, status: "public", region: "US", note: "Spreadsheet-based PM. Highly commoditizable by any AI that can manage a to-do list.", analystDetail: {
      ...
      { name: "ClickUp", ticker: "private", drop: null, status: "private", region: "US", note: "Raised $400M at $4B. Private = shielded from selloff but faces same existential risk." },
      { name: "Notion", ticker: "private", drop: null, status: "private", region: "US", note: "Pivoting toward AI-native workspace. Better positioned than pure PM tools." },
    ],
  ...
  },
  {
    ...
    companies: [
      { name: "Intuit (QBO)", ticker: "INTU", drop: -34, status: "public", region: "US", note: "QuickBooks dominates US SMB (~62% share). P/E compressed 38% despite 12-13% revenue growth.", analystDetail: {
      ...
      { name: "FreshBooks", ticker: "private", drop: null, status: "private", region: "Canada", note: "Popular with freelancers/micro-businesses. Invoicing-centric — more vulnerable than full accounting." },
      { name: "Wave", ticker: "private", drop: null, status: "private", region: "Canada", note: "Free accounting for micro-businesses. Owned by H&R Block. Revenue = payments, not seats." },
      { name: "Xero", ticker: "XRO.AX", drop: -16, status: "public", region: "ANZ", note: "NZ/Australia leader. Worst day since March 2020. Was trading at 102x earnings pre-crash.", analystDetail: {
      ...
      { name: "Sage Group", ticker: "SGE.L", drop: -8, status: "public", region: "Europe", note: "UK/Europe. Most resilient — Making Tax Digital in UK = moat. 10% organic growth." },
      { name: "TOTVS", ticker: "TOTS3.SA", drop: -15, status: "public", region: "LATAM", note: "Brazil leader (~50% market share). 27% ARR growth. Brazilian tax complexity = fortress.", analystDetail: {
  ...
  },
  {
    ...
    companies: [
      { name: "Gusto", ticker: "private", drop: null, status: "private", region: "US", note: "400K+ SMB customers. $9.5B valuation. 'People platform for Main Street.' US-focused, sticky." },
      { name: "Rippling", ticker: "private", drop: null, status: "private", region: "US", note: "$13.5B valuation. HR + IT + payroll unified. 160+ countries. Fast-growing, shielded from selloff." },
      { name: "ADP (RUN)", ticker: "ADP", drop: -8, status: "public", region: "US", note: "SMB product RUN. 50+ years dividends. 140 countries. Maximum regulatory moat.", analystDetail: {
      ...
      { name: "Paychex", ticker: "PAYX", drop: -12, status: "public", region: "US", note: "~730K SMB clients. Benefits, HR, payroll bundle. Defensive, recession-resilient." },
      { name: "Paycom", ticker: "PAYC", drop: -41, status: "public", region: "US", note: "Already sells outcomes (Beti automates payroll). Drop = macro fear, not disruption.", analystDetail: {
      ...
      { name: "Paylocity", ticker: "PCTY", drop: -40, status: "public", region: "US", note: "14% recurring revenue growth, 35.9% EBITDA margins. Raised revenue target $2B→$3B.", analystDetail: {
      ...
      { name: "Deel", ticker: "private", drop: null, status: "private", region: "Global", note: "Global payroll/EOR in 150+ countries. $12B valuation. Growing rapidly in distributed teams." },
      { name: "Personio", ticker: "private", drop: null, status: "private", region: "Europe", note: "€8.5B. European SMB HR + payroll. EU labor law complexity = natural moat." },
  ...
  },
  {
    ...
    companies: [
      { name: "Toast", ticker: "TOST", drop: -33, status: "public", region: "US", note: "Restaurant-specific POS. $14B market cap. 25% YoY growth. AI for menu/labor analytics. Reports Feb 12.", analystDetail: {
      ...
      { name: "Block (Square)", ticker: "XYZ", drop: -15, status: "public", region: "US", note: "POS + payments + payroll + lending. Hardware moat. Broad SMB ecosystem.", analystDetail: {
      ...
      { name: "Lightspeed", ticker: "LSPD", drop: -20, status: "public", region: "Canada", note: "Restaurant + retail POS. Multi-location inventory. More volatile, smaller.", analystDetail: {
      ...
      { name: "Clover (Fiserv)", ticker: "FI", drop: -5, status: "public", region: "US", note: "Clover is Fiserv's SMB POS. Parent company is a $90B fintech giant — minimal SaaS exposure." },
      { name: "SpotOn", ticker: "private", drop: null, status: "private", region: "US", note: "Restaurant POS challenger. Private. Staff scheduling + reservation integration." },
      { name: "Otter (DoorDash)", ticker: "DASH", drop: -8, status: "public", region: "US", note: "Delivery aggregator + POS layer. Owned by DoorDash. Multi-channel order unification." },
      { name: "HungerRush", ticker: "private", drop: null, status: "private", region: "US", note: "QSR/pizza focused POS. AI voice ordering for drive-thrus. Private." },
    ],
  ...
  },
  {
    ...
    regulatoryShield: "Medium",
    companies: [
      { name: "Cloudbeds", ticker: "private", drop: null, status: "private", region: "US", note: "All-in-one PMS for independents. 157 countries. Launched 'Signals' AI for demand forecasting." },
      { name: "Mews", ticker: "private", drop: null, status: "private", region: "Europe", note: "Raised $300M at $2.5B (Jan 2026). 12,500 properties. Largest-ever hotel PMS round." },
      { name: "Guesty", ticker: "private", drop: null, status: "private", region: "Global", note: "Short-term rental PMS. Multi-channel (Airbnb, VRBO, Booking.com). Raised $170M." },
      { name: "Apaleo", ticker: "private", drop: null, status: "private", region: "Europe", note: "API-first PMS. First to launch AI agent marketplace. €20M raised. Modular approach." },
      { name: "StayNTouch", ticker: "private", drop: null, status: "private", region: "US", note: "Mobile-first PMS. AWS-hosted. 100% uptime focus. Contactless check-in." },
      { name: "Agilysys", ticker: "AGYS", drop: -10, status: "public", region: "US", note: "Only major public PMS pure-play. $150M spa acquisition. Mostly enterprise but SMB push.", analystDetail: {
      ...
      { name: "Sabre", ticker: "SABR", drop: null, status: "public", region: "US", note: "SynXis Property Hub — cloud-native hotel PMS. Travel distribution + hospitality tech." },
      { name: "SiteMinder", ticker: "SDR.AX", drop: null, status: "public", region: "ANZ", note: "Hotel distribution + Little Hotelier PMS for small properties. ASX-listed." },
    ],
  ...
  },
  {
    ...
    companies: [
      { name: "DocuSign", ticker: "DOCU", drop: -52, status: "public", region: "US", note: "-85% from ATH. E-signature is a thin layer — AI generates AND routes the document.", analystDetail: {
      ...
      { name: "PandaDoc", ticker: "private", drop: null, status: "private", region: "Europe", note: "SMB proposal/contract tool. Private. Faces same commoditization risk." },
      { name: "Dropbox Sign", ticker: "DBX", drop: -25, status: "public", region: "US", note: "Formerly HelloSign. Part of Dropbox. Storage moat helps but e-sign is vulnerable.", analystDetail: {
  ...
  },
  {
    ...
    regulatoryShield: "Low",
    companies: [
      { name: "Shopify", ticker: "SHOP", drop: -18, status: "public", region: "Canada", note: "Merchant ecosystem + payments + shipping + POS hardware. Relatively defensive for SMB SaaS.", analystDetail: {
      ...
      { name: "BigCommerce", ticker: "BIGC", drop: -30, status: "public", region: "US", note: "Smaller competitor. Less ecosystem lock-in than Shopify. More vulnerable.", analystDetail: {
      ...
      { name: "Wix", ticker: "WIX", drop: -25, status: "public", region: "Global", note: "Website builder + e-commerce. AI can now build sites from a prompt — direct threat.", analystDetail: {
      ...
      { name: "Squarespace", ticker: "SQSP", drop: -20, status: "public", region: "US", note: "Design-focused sites. Went private via Permira buyout 2024. Re-listed. Vulnerable to vibe coding." },
      { name: "VTEX", ticker: "VTEX", drop: -15, status: "public", region: "LATAM", note: "LatAm e-commerce platform. Regional focus provides some protection." },
    ],
    ...
    companies: [
      {
        ...
        status: "public",
        region: "Canada",
        note: "Canada's largest; ~$100B+ market cap. Volaris, Harris, Topicus operating groups. Archetype of the software consolidator model.",
        consolidatorDetail: {
          focus: "Vertical market software across government, healthcare, retail, construction, hospitality, and professional services. Volaris targets lower-end verticals; Harris focuses on healthcare/public safety; Topicus on Europe.",
          investmentThesis: "Acquire and hold forever. Buy vertical software with strong customer lock-in, minimal cannibalization risk, and predictable cash flows. Never sell—operate for decades. AI disruption of targets may create cheaper acquisition multiples.",
          similarSectors: ["hotel", "pos", "accounting"],
          analystDetail: {
            consensus: "Buy",
            targetMedian: "C$4,200",
            targetRange: "C$3,800–C$4,800",
            analystCount: 12,
            consensusDate: "Feb 2026",
            bullCaseDate: "Feb 2026",
            bearCaseDate: "Feb 2026",
            bullCase: "Archetype of the perpetual-hold consolidator model. 300+ acquisitions, zero divestments. Volaris/Harris/Topicus structure allows scale without integration overhead. SaaSpocalypse creates cheaper targets.",
            bearCase: "Portfolio includes CRM, PM, and other seat-exposed verticals. If AI truly disrupts per-seat SaaS, acquired businesses may need costly pivots. Canadian macro exposure.",
            verdict: "MOSTLY HYPE — CSU is precisely the acquirer that benefits from sector panic. Cheaper multiples, stronger targets fleeing to safety. The model is defensive by design.",
            sentiment: "green",
          },
        },
      },
      {
        ...
        status: "public",
        region: "US",
        note: "Workforce management. HR/payroll vertical.",
        consolidatorDetail: {
          focus: "SMB workforce management: payroll, HR, compliance, time & attendance. Targets employers with 1–500 employees. Compliance-heavy vertical.",
          investmentThesis: "HR/payroll is regulatory-shielded. Labor law complexity creates moat. Consolidation of fragmented SMB providers builds scale. Different exposure than pure per-seat SaaS.",
          similarSectors: ["payroll", "accounting"],
          analystDetail: null,
        },
      },
      {
        ...
        status: "public",
        region: "US",
        note: "Productivity/workflow software roll-up.",
        consolidatorDetail: {
          focus: "Productivity and workflow: project management, marketing automation, CRM, document management. Acquires growth-challenged SaaS at low multiples.",
          investmentThesis: "Buy distressed or underperforming SaaS, cut costs, integrate. Higher exposure to seat-based products (PM, CRM) than other consolidators. SaaSpocalypse may pressure portfolio.",
          similarSectors: ["crm", "project", "document"],
          analystDetail: null,
        },
      },
    ],
